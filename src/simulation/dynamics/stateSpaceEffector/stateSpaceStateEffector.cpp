...
StateSpaceStateEffector::~StateSpaceStateEffector() { StateSpaceStateEffector::effectorID--; }
...
void StateSpaceStateEffector::updateEffectorMassProps(double integTime) {
    ...
    Eigen::Matrix3d ISPntB_B =
        this->dcm_FB.transpose() * this->ISPntSc_F * this->dcm_FB - this->mass * rTilde_ScB_B * rTilde_ScB_B;
...
void StateSpaceStateEffector::updateEnergyMomContributions(double integTime,
