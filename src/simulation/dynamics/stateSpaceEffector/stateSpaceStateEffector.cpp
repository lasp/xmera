...
void StateSpaceStateEffector::updateContributions(
    double integTime,
...
void StateSpaceStateEffector::computeDerivatives(
    double integTime,
...
void StateSpaceStateEffector::updateEnergyMomContributions(
    double integTime,
