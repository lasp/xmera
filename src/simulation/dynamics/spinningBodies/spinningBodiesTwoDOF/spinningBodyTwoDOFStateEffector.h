...
class SpinningBodyTwoDOFStateEffector : public StateEffector, public SysModel {
   ...
   private:
    ...
    Eigen::Vector3d r_Sc1N_N{0.0, 0.0, 0.0};   //!< [m] position vector of lower spinning body center of mass Sc1
                                               //!< relative to the inertial frame origin N
    Eigen::Vector3d r_Sc2N_N{0.0, 0.0, 0.0};   //!< [m] position vector of upper spinning body center of mass Sc2
                                               //!< relative to the inertial frame origin N
