...
class PrescribedMotionStateEffector : public StateEffector, public SysModel {
   public:
    ...
    ReadFunctor<PrescribedRotationMsgPayload>
        prescribedRotationInMsg;  //!< Input message for the effector's hub-relative rotational prescribed states
    ReadFunctor<PrescribedTranslationMsgPayload>
        prescribedTranslationInMsg;  //!< Input message for the effector's hub-relative translational prescribed states
    Message<PrescribedRotationMsgPayload>
        prescribedRotationOutMsg;  //!< Output message for the effector's hub-relative rotational prescribed states
    Message<PrescribedTranslationMsgPayload>
        prescribedTranslationOutMsg;  //!< Output message for the effector's hub-relative translational prescribed
                                      //!< states
   ...
   private:
    ...
    Eigen::Matrix3d IPntFc_F;  //!< [kg-m^2] Effector's inertia matrix about its center of mass point Fc expressed in F
                               //!< frame components
    Eigen::Vector3d r_FcF_F;   //!< [m] Position vector of the effector's center of mass point Fc relative to the
                               //!< effector's body frame origin point F expressed in F frame components
    Eigen::Vector3d r_FM_M;    //!< [m] Position vector of the effector's body frame origin point F relative to the
                               //!< hub-fixed mount frame origin point M expressed in M frame components
    ...
    Eigen::Vector3d omega_FM_F;  //!< [rad/s] Angular velocity of the effector body frame F relative to the hub-fixed
                                 //!< mount frame M expressed in F frame components
    Eigen::Vector3d omegaPrime_FM_F;  //!< [rad/s^2] Angular acceleration of the effector body frame F relative to the
                                      //!< hub-fixed mount frame M expressed in F frame components
    Eigen::MRPd sigma_FM;    //!< MRP attitude of the effector's body frame F relative to the hub-fixed mount frame M
    Eigen::Vector3d r_MB_B;  //!< [m] Position vector describing the hub-fixed mount frame origin point M location
                             //!< relative to the hub frame origin point B expressed in B frame components
    Eigen::Vector3d omega_MB_M;  //!< [rad/s] Angular velocity of the hub-fixed mount frame M relative to the hub frame
                                 //!< B expressed in M frame components
    Eigen::Vector3d omegaPrime_MB_B;  //!< [rad/s^2] Angular acceleration of the hub-fixed mount frame M relative to the
                                      //!< hub frame B expressed in B frame components
    Eigen::MRPd sigma_MB;             //!< MRP attitude of the hub-fixed frame M relative to the hub body frame B

    // Other module vectors
    Eigen::Vector3d r_FcF_B;       //!< [m] Position vector of the effector center of mass point Fc relative to point F
                                   //!< expressed in B frame components
    Eigen::Vector3d r_FcB_B;       //!< [m] Position vector of the effector center of mass point Fc relative to point B
                                   //!< expressed in B frame components
    ...
    Eigen::Vector3d
        rPrimePrime_FM_B;  //!< [m/s^2] B frame time derivative of rPrime_FM_B expressed in B frame components
    Eigen::Vector3d
        omega_FB_B;  //!< [rad/s] Angular velocity of frame F relative to frame B expressed in B frame components
    Eigen::Vector3d omega_BN_B;  //!< [rad/s] Angular velocity of frame B relative to the inertial frame N expressed in
                                 //!< B frame components
    Eigen::Vector3d omega_FN_B;  //!< [rad/s] Angular velocity of frame F relative to the inertial frame N expressed in
                                 //!< B frame components
    Eigen::Vector3d
        omegaPrime_FB_B;  //!< [rad/s^2] B frame time derivative of omega_FB_B expressed in B frame components
    ...
    Eigen::Matrix3d IPntFc_B;  //!< [kg-m^2] Effector inertia matrix about its center of mass point Fc expressed in B
                               //!< frame components
    ...
    Eigen::Vector3d r_FcN_N;   //!< [m] Position vector of the effector center of mass point Fc relative to the inertial
                               //!< frame origin point N expressed in inertial frame N components
    Eigen::Vector3d v_FcN_N;   //!< [m/s] Velocity vector of the effector center of mass point Fc relative to the
                               //!< inertial frame origin point N expressed in inertial frame N components
    Eigen::Vector3d sigma_FN;  //!< MRP attitude of the effector body frame F relative to the inertial frame N
    Eigen::Vector3d omega_FN_F;  //!< [rad/s] Angular velocity of frame F relative to the inertial frame N expressed in
                                 //!< F frame components
    ...
    Eigen::MatrixXd*
        inertialPositionProperty;  //!< [m] r_N Hub inertial position vector relative to system spice zeroBase/refBase
    Eigen::MatrixXd*
        inertialVelocityProperty;  //!< [m] v_N Hub inertial velocity vector relative to system spice zeroBase/refBase
