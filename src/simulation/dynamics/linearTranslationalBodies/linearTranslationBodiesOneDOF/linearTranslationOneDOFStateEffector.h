...
public:
    ...
    void setRhoInit(double rhoInit) {
        this->rhoInit = rhoInit;
    }

    /** setter for `rhoDotInit` property */
    void setRhoDotInit(double rhoDotInit) {
    ...
    void setR_FcF_F(Eigen::Vector3d r_FcF_F) {
        this->r_FcF_F = r_FcF_F;
    }

    /** setter for `r_F0B_B` property */
    void setR_F0B_B(Eigen::Vector3d r_F0B_B) {
        this->r_F0B_B = r_F0B_B;
    }

    /** setter for `IPntFc_F` property */
    void setIPntFc_F(Eigen::Matrix3d IPntFc_F) {
        this->IPntFc_F = IPntFc_F;
    }

    /** setter for `dcm_FB` property */
    void setDCM_FB(Eigen::Matrix3d dcm_FB) {
        this->dcm_FB = dcm_FB;
    }
    ...
    /** setter for `rhoInit` property */
    double getRhoInit() const {
        return this->rhoInit;
    }

    /** setter for `rhoDotInit` property */
    double getRhoDotInit() const {
        return this->rhoDotInit;
    }

    /** setter for `fHat_B` property */
    Eigen::Vector3d getFHat_B() const {
        return this->fHat_B;
    }

    /** setter for `r_FcF_F` property */
    Eigen::Vector3d getR_FcF_F() const {
        return this->r_FcF_F;
    }

    /** setter for `r_F0B_B` property */
    Eigen::Vector3d getR_F0B_B() const {
        return this->r_F0B_B;
    }

    /** setter for `IPntFc_F` property */
    Eigen::Matrix3d getIPntFc_F() const {
        return IPntFc_F;
    }

    /** setter for `dcm_FB` property */
    Eigen::Matrix3d getDCM_FB() const {
        return dcm_FB;
    }
...
private:
    ...
    void computeBackSubContributions(BackSubMatrices &backSubContr, Eigen::Vector3d const &F_g);
