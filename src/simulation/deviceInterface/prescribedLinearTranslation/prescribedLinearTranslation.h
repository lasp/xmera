...
class PrescribedLinearTranslation : public SysModel {
   ...
   private:
    ...
    void computeSmoothedBangBangParameters();  //!< Method for computing the required parameters for the translation
                                               //!< with a smoothed bang-bang acceleration profile
    ...
    void computeTranslationComplete();  //!< Method for computing the scalar translational states when the translation
                                        //!< is complete
