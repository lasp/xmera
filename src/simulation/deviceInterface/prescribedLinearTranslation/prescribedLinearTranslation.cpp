...
*/
void PrescribedLinearTranslation::setCoastOptionBangDuration(double const coastOptionBangDuration) {
...
*/
void PrescribedLinearTranslation::setSmoothingDuration(double const smoothingDuration) {
...
*/
void PrescribedLinearTranslation::setTransAccelMax(double const transAccelMax) {
...
*/
void PrescribedLinearTranslation::setTransHat_M(Eigen::Vector3d const &transHat_M) {
...
*/
void PrescribedLinearTranslation::setTransPosInit(double const transPosInit) {
...
*/
Eigen::Vector3d const &PrescribedLinearTranslation::getTransHat_M() const {
