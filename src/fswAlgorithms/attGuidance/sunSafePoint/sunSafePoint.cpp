...
void SunSafePoint::updateState(uint64_t callTime) {
    ...
    if (this->imuInMsg.isWritten()) { imuMsgPayload = this->imuInMsg(); }
    auto sunDirectionMsgPayload = NavAttMsgPayload();
    if (this->sunDirectionInMsg.isWritten()) { sunDirectionMsgPayload = this->sunDirectionInMsg(); }
...
/*! Getter method for the minimally accepted sun body vector norm.
 @return double
*/
double SunSafePoint::getMinUnitMag() const {
    return this->algorithm.getMinUnitMag();
}

/*! Getter method for the small alignment tolerance angle near 0 or 180 degrees.
 @return double
*/
double SunSafePoint::getSmallAngle() const {
    return this->algorithm.getSmallAngle();
}

/*! Getter method for the desired constant spin rate about sun heading vector.
 @return double
*/
double SunSafePoint::getSunAxisSpinRate() const {
    return this->algorithm.getSunAxisSpinRate();
}

/*! Getter method for the desired body rate vector if no sun direction is available.
 @return Eigen::Vector3d
*/
Eigen::Vector3d SunSafePoint::getOmega_RN_B() const {
    return this->algorithm.getOmega_RN_B();
}

/*! Getter method for the desired body vector to point at the sun.
 @return Eigen::Vector3d
*/
Eigen::Vector3d SunSafePoint::getSHatBdyCmd() const {
    return this->algorithm.getSHatBdyCmd();
}
...
*/
void SunSafePoint::setMinUnitMag(double const minUnitMag) {
    this->algorithm.setMinUnitMag(minUnitMag);
}
...
*/
void SunSafePoint::setSmallAngle(double const smallAngle) {
    this->algorithm.setSmallAngle(smallAngle);
}
...
*/
void SunSafePoint::setSunAxisSpinRate(double const sunAxisSpinRate) {
...
*/
void SunSafePoint::setOmega_RN_B(Eigen::Vector3d const &omega_RN_B) {
    this->algorithm.setOmega_RN_B(omega_RN_B);
}
...
void SunSafePoint::setSHatBdyCmd(Eigen::Vector3d &sHatBdyCmd) {
    this->algorithm.setSHatBdyCmd(sHatBdyCmd);
}
