...
class SunSafePointAlgorithm {
   ...
   private:
    ...
    double minUnitMag{0.1};                     //!< The minimally acceptable norm of sun body vector
    double smallAngle{0.00017};                 //!< [rad] An angle value that specifies what is near 0 or 180 degrees
    ...
    Eigen::Vector3d sunMnvrVec{0.0, 0.0, 1.0};  //!< The Eigen axis that we want to rotate on to get sun
