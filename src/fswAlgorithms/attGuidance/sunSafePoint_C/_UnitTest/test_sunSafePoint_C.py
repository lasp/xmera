...
from Basilisk.fswAlgorithms import sunSafePoint_C                   # import the module that is to be tested
...
def sunSafePointTestFunction(show_plots, case):
    ...
    module = sunSafePoint_C.SunSafePoint_C()
