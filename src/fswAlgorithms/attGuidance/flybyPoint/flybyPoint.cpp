...
double FlybyPoint::getTimeBetweenFilterData() const { return this->timeBetweenFilterData; }

void FlybyPoint::setTimeBetweenFilterData(double time) { this->timeBetweenFilterData = time; }

double FlybyPoint::getToleranceForCollinearity() const { return this->toleranceForCollinearity; }

void FlybyPoint::setToleranceForCollinearity(double tolerance) { this->toleranceForCollinearity = tolerance; }

/*! Get the sign (+1 or -1) of the axis of rotation of the Z axis during the flyby
 @param int sign (+1 or -1)
 */
int FlybyPoint::getSignOfOrbitNormalFrameVector() const { return this->signOfOrbitNormalFrameVector; }

/*! Set the sign (+1 or -1) of the axis of rotation of the Z axis during the flyby
 @param int sign (+1 or -1)
 */
void FlybyPoint::setSignOfOrbitNormalFrameVector(int sign) { this->signOfOrbitNormalFrameVector = sign; }

/*! Get the maximum acceleration threshold to consider a solution invalid
 @return double maximum accceleration
 */
double FlybyPoint::getMaximumAccelerationThreshold() const { return this->maxAcceleration; }
...
/*! Get the maximum rate threshold to consider a solution invalid
 @return maximum rate
 */
double FlybyPoint::getMaximumRateThreshold() const { return this->maxRate; }

/*! Set the maximum rate threshold to consider a solution invalid
 @param maximum rate
 */
void FlybyPoint::setMaximumRateThreshold(double maxRateThreshold) { this->maxRate = maxRateThreshold; }

/*! Get the ground based positional knowledge standard deviation
 @return sigma
 */
double FlybyPoint::getPositionKnowledgeSigma() const { return this->positionKnowledgeSigma; }
