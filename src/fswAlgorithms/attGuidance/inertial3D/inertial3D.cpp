...
*/
void Inertial3D::setSigmaR0N(Eigen::Vector3d const &sigma_RN) {
    this->algorithm.setSigmaR0N(sigma_RN);
}

/*! Getter method for the MRP from frame N to frame R.
 @return const Eigen::Vector3d
*/
Eigen::Vector3d const &Inertial3D::getSigmaR0N() const {
    return this->algorithm.getSigmaR0N();
}
