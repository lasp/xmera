...
void CelestialTwoBodyPoint_C::reset(uint64_t callTime) {
 ...
 */
void CelestialTwoBodyPoint_C::updateState(uint64_t callTime) {
...
/*! This method takes the navigation translational info as well as the spice data of the
 ...
 @return void
 */
void CelestialTwoBodyPoint_C::parseInputMessages() {
...
/*! This method takes the spacecraft and points a specified axis at a named
 ...
 @param callTime The clock time at which the function was called (nanoseconds)
 */
void CelestialTwoBodyPoint_C::computeCelestialTwoBodyPoint(uint64_t callTime) {
