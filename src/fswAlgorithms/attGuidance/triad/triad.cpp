...
double SPE_angle(Eigen::Vector3d const &v1, Eigen::Vector3d const &v2) {
...
void Triad::reset(uint64_t callTime) {
    if (!this->attNavInMsg.isLinked()) { this->bskLogger.bskLog(BSK_ERROR, " triad.attNavInMsg wasn't connected."); }
...
/*! Setter method for sigma_R0R.
 ...
 @param a1Hat_B
*/
void Triad::setA1Hat_B(Eigen::Vector3d const &a1Hat_B) {
    this->a1Hat_B = a1Hat_B;
}
...
/*! Setter method for sigma_R0R.
 ...
 @param h1Hat_B
*/
void Triad::setH1Hat_B(Eigen::Vector3d const &h1Hat_B) {
    this->h1Hat_B = h1Hat_B;
}
...
/*! Setter method for sigma_R0R.
 ...
 @param hHat_N
*/
void Triad::setHHat_N(Eigen::Vector3d const &hHat_N) {
    this->hHat_N = hHat_N;
}
...
*/
void Triad::setCelestialBodyInput(CelestialBody const &celestialBodyInput) {
...
/*! Setter method for sigma_R0R.
 ...
 @param bodyAxisInput
*/
void Triad::setBodyAxisInput(BodyAxisInput const &bodyAxisInput) {
    this->bodyAxisInput = bodyAxisInput;
}
...
*/
void Triad::setInertialAxisInput(InertialAxisInput const &inertialAxisInput) {
...
*/
Eigen::Vector3d const Triad::getA1Hat_B() const {
    return this->a1Hat_B;
}
...
/*! Getter method for h1Hat_B.
    @return const Eigen::Vector3d
*/
Eigen::Vector3d const Triad::getH1Hat_B() const {
    return this->h1Hat_B;
}
...
/*! Getter method for hHat_N.
    @return const Eigen::Vector3d
*/
Eigen::Vector3d const Triad::getHHat_N() const {
    return this->hHat_N;
}
...
*/
CelestialBody const Triad::getCelestialBodyInput() const {
    return this->celestialBodyInput;
}

/*! Getter method for bodyAxisInput.
    @return const BodyAxisInput
*/
BodyAxisInput const Triad::getBodyAxisInput() const {
    return this->bodyAxisInput;
}

/*! Getter method for inertialAxisInput.
    @return const InertialAxisInput
*/
InertialAxisInput const Triad::getInertialAxisInput() const {
    return this->inertialAxisInput;
}
