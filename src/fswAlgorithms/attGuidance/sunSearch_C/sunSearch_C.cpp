 ...
 */
void SunSearch_C::updateState(uint64_t currentSimNanos) {
...
/*! Set the slew angle
    ...
    @return void
    */
void SunSearch_C::setSlewAngle(double const theta1, double const theta2, double const theta3) {
...
/*! Set the maximum angle rate
    ...
    @return void
    */
void SunSearch_C::setMaxRate(double const omega1, double const omega2, double const omega3) {
...
/*! Set the rotation axis
    ...
    @return void
    */
void SunSearch_C::setRotAxis(int const a1, int const a2, int const a3) {
...
/*! Set the maximum torque
    ...
    @return void
    */
void SunSearch_C::setMaxTorque(double const u1, double const u2, double const u3) {
