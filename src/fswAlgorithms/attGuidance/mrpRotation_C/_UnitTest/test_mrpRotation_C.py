...
from Basilisk.fswAlgorithms import mrpRotation_C                    # import the module that is to be tested
from Basilisk.utilities import macros as mc
from Basilisk.architecture import messaging


sys.path.append(path + '/Support')
import truth_mrpRotation_C as truth
...
def test_mrpRotation_C(show_plots, cmdStateFlag, testReset):
    """Module Unit Test"""
...
def run(show_plots, cmdStateFlag, testReset):
    ...
    module = mrpRotation_C.MrpRotation_C()
