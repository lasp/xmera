 ...
 */
void MrpRotation_C::reset(uint64_t callTime) {
...
/*! @brief This method takes the input attitude reference frame, and and superimposes the dynamics MRP
 ...
 @param callTime The clock time at which the function was called (nanoseconds)
 */
void MrpRotation_C::updateState(uint64_t callTime) {
    /* - Read input messages */
...
/*! @brief This function checks if there is a new commanded raster maneuver message available
 @return void
 */
void MrpRotation_C::checkRasterCommands() {
...
/*! @brief This function computes control update time
 ...
 @param callTime The clock time at which the function was called (nanoseconds)
*/
void MrpRotation_C::computeTimeStep(uint64_t callTime) {
    if (this->priorTime == 0) {
        this->dt = 0.0;
    } else {
