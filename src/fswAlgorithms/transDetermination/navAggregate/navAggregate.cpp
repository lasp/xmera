...
void NavAggregate::setAttTimeIdx(uint32_t idx) {
    this->algorithm.setAttTimeIdx(idx);
}
 ...
 */
uint32_t NavAggregate::getAttTimeIdx() const {
    return this->algorithm.getAttTimeIdx();
}
...
void NavAggregate::setTransTimeIdx(uint32_t idx) {
    this->algorithm.setTransTimeIdx(idx);
}
 ...
 */
uint32_t NavAggregate::getTransTimeIdx() const {
    return this->algorithm.getTransTimeIdx();
}
 ...
 */
uint32_t NavAggregate::getAttIdx() const {
    return this->algorithm.getAttIdx();
}
 ...
 */
uint32_t NavAggregate::getRateIdx() const {
    return this->algorithm.getRateIdx();
}
 ...
 */
uint32_t NavAggregate::getPosIdx() const {
    return this->algorithm.getPosIdx();
}
 ...
 */
uint32_t NavAggregate::getVelIdx() const {
    return this->algorithm.getVelIdx();
}
 ...
 */
uint32_t NavAggregate::getDvIdx() const {
    return this->algorithm.getDvIdx();
}
 ...
 */
uint32_t NavAggregate::getSunIdx() const {
    return this->algorithm.getSunIdx();
}
...
void NavAggregate::setAttMsgCount(uint32_t msgCount) {
    this->algorithm.setAttMsgCount(msgCount);
}
 ...
 */
uint32_t NavAggregate::getAttMsgCount() const {
    return this->algorithm.getAttMsgCount();
}
...
void NavAggregate::setTransMsgCount(uint32_t msgCount) {
    this->algorithm.setTransMsgCount(msgCount);
}
 ...
 */
uint32_t NavAggregate::getTransMsgCount() const {
    return this->algorithm.getTransMsgCount();
}
