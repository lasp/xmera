...
class OEStateEphem : public SysModel {
   public:
    ...
    void setArcRadiusPeriapsisCoefficients(signed int arcNumber,
                                           const std::array<double, MAX_OE_COEFF> &radiusPeriapsisCoefficients);
    std::array<double, MAX_OE_COEFF> getArcRadiusPeriapsisCoefficients(signed int arcNumber);
    void setArcEccentricityCoefficients(signed int arcNumber,
                                        const std::array<double, MAX_OE_COEFF> &eccentricityCoefficients);
    std::array<double, MAX_OE_COEFF> getArcEccentricityCoefficients(signed int arcNumber);
    void setArcInclinationCoefficients(signed int arcNumber,
                                       const std::array<double, MAX_OE_COEFF> &inclinationCoefficients);
    std::array<double, MAX_OE_COEFF> getArcInclinationCoefficients(signed int arcNumber);
    void setArcArgPeriapsisCoefficients(signed int arcNumber,
                                        const std::array<double, MAX_OE_COEFF> &argPeriapsisCoefficients);
    std::array<double, MAX_OE_COEFF> getArcArgPeriapsisCoefficients(signed int arcNumber);
    void setArcRaanCoefficients(signed int arcNumber, const std::array<double, MAX_OE_COEFF> &raanCoefficients);
    std::array<double, MAX_OE_COEFF> getArcRaanCoefficients(signed int arcNumber);
    void setArcTrueAnomalyCoefficients(signed int arcNumber,
                                       const std::array<double, MAX_OE_COEFF> &trueAnomalyCoefficients);
    std::array<double, MAX_OE_COEFF> getArcTrueAnomalyCoefficients(signed int arcNumber);
