...
void OEStateEphemAlgorithm::setArcNumberOfCoefficients(const signed int arcNumber,
                                                       const signed int numberOfCoefficients) {
    this->fitCoefficients[arcNumber].numberChebCoefficients = numberOfCoefficients;
};

signed int OEStateEphemAlgorithm::getArcNumberOfCoefficients(const signed int arcNumber) const {
    return this->fitCoefficients[arcNumber].numberChebCoefficients;
};

void OEStateEphemAlgorithm::setArcMiddleTime(const signed int arcNumber, const double timeMiddle) {
    this->fitCoefficients[arcNumber].ephemerisTimeMiddle = timeMiddle;
};

double OEStateEphemAlgorithm::getArcMiddleTime(const signed int arcNumber) const {
    return this->fitCoefficients[arcNumber].ephemerisTimeMiddle;
};

void OEStateEphemAlgorithm::setArcRadiusTime(const signed int arcNumber, const double timeRadius) {
    this->fitCoefficients[arcNumber].ephemerisTimeRadius = timeRadius;
};

double OEStateEphemAlgorithm::getArcRadiusTime(const signed int arcNumber) const {
    return this->fitCoefficients[arcNumber].ephemerisTimeRadius;
};

void OEStateEphemAlgorithm::setArcAnomalyFlag(const signed int arcNumber, const signed int anomalyFlag) {
    this->fitCoefficients[arcNumber].anomalyFlag = anomalyFlag;
};

signed int OEStateEphemAlgorithm::getArcAnomalyFlag(signed int arcNumber) const {
...
std::array<double, MAX_OE_COEFF> OEStateEphemAlgorithm::getArcRadiusPeriapsisCoefficients(const signed int arcNumber) {
...
std::array<double, MAX_OE_COEFF> OEStateEphemAlgorithm::getArcEccentricityCoefficients(const signed int arcNumber) {
...
std::array<double, MAX_OE_COEFF> OEStateEphemAlgorithm::getArcInclinationCoefficients(const signed int arcNumber) {
...
std::array<double, MAX_OE_COEFF> OEStateEphemAlgorithm::getArcArgPeriapsisCoefficients(const signed int arcNumber) {
    return this->fitCoefficients[arcNumber].argPeriapsisCoefficients;
};

void OEStateEphemAlgorithm::setArcRaanCoefficients(const signed int arcNumber,
                                                   const std::array<double, MAX_OE_COEFF> &raanCoefficients) {
    this->fitCoefficients[arcNumber].raanCoefficients = raanCoefficients;
};

std::array<double, MAX_OE_COEFF> OEStateEphemAlgorithm::getArcRaanCoefficients(const signed int arcNumber) {
...
std::array<double, MAX_OE_COEFF> OEStateEphemAlgorithm::getArcTrueAnomalyCoefficients(const signed int arcNumber) {
