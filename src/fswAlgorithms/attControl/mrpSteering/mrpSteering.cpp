...
void MrpSteering::reset(uint64_t callTime) {
    ...
    if (!this->guidInMsg.isLinked()) { throw std::invalid_argument("mrpSteering.guidInMsg wasn't connected."); }
}
...
*/
void MrpSteering::setK1(double const gain) {
    this->algorithm.setK1(gain);
}

/*! Get the linear feedback gain K1
 @return double
*/
double MrpSteering::getK1() const {
    return this->algorithm.getK1();
}
...
*/
void MrpSteering::setK3(double const gain) {
    this->algorithm.setK3(gain);
}

/*! Get the cubic feedback gain K3
 @return double
*/
double MrpSteering::getK3() const {
    return this->algorithm.getK3();
}
...
*/
void MrpSteering::setOmegaMax(double const omega) {
    this->algorithm.setOmegaMax(omega);
}

/*! Get the maximum rate command of steering control
 @return double
*/
double MrpSteering::getOmegaMax() const {
    return this->algorithm.getOmegaMax();
}
...
*/
void MrpSteering::setIgnoreFeedforward(bool const ignore) {
    this->algorithm.setIgnoreFeedforward(ignore);
}

/*! Get whether the outer loop feed-forward is ignored
 @return bool
*/
bool MrpSteering::getIgnoreFeedforward() const {
    return this->algorithm.getIgnoreFeedforward();
}
