...
void MrpFeedback::reset(uint64_t callTime) {
    ...
    if (!this->guidInMsg.isLinked()) { throw std::invalid_argument("MrpFeedback.guidInMsg wasn't connected."); }
...
*/
void MrpFeedback::setK(double const gain) {
    this->algorithm.setK(gain);
}

/*! Getter method for the gain K.
 @return const double
*/
double MrpFeedback::getK() const {
    return this->algorithm.getK();
}
...
*/
void MrpFeedback::setP(double const gain) {
...
*/
void MrpFeedback::setKi(double const gain) {
...
/*! Getter method for the gain Ki.
 @return const double
*/
double MrpFeedback::getKi() const {
...
*/
void MrpFeedback::setIntegralLimit(double const limit) {
...
/*! Getter method for the integral limit.
 @return const double
*/
double MrpFeedback::getIntegralLimit() const {
...
*/
void MrpFeedback::setControlLawType(int const type) {
    this->algorithm.setControlLawType(type);
}

/*! Getter method for the control law type.
 @return const int
*/
int MrpFeedback::getControlLawType() const {
    return this->algorithm.getControlLawType();
}
...
*/
void MrpFeedback::setKnownTorquePntB_B(Eigen::Vector3d const &knownTorquePntB_B) {
...
*/
Eigen::Vector3d MrpFeedback::getKnownTorquePntB_B() const {
