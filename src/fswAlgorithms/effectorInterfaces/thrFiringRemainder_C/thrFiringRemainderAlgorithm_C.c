...
void reset(ThrFiringRemainderInternalState* moduleState, const THRArrayConfigMsgPayload localThrusterData) {
     ...
     */
    moduleState->defaultControlPeriod =
        0.0 == moduleState->defaultControlPeriod ? 2.0 : moduleState->defaultControlPeriod;
}
