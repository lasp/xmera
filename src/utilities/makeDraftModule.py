...
class moduleGenerator:
    ...
    def createTestFile(self, type):
        ...
        testFile += '\n'
        testFile += 'from xmera.utilities import SimulationBaseClass\n'
        testFile += 'from xmera.utilities import unitTestSupport\n'
        testFile += 'from xmera.architecture import messaging\n'
        testFile += 'from xmera.utilities import macros\n'
        testFile += 'from xmera.' + os.path.split(self.modulePathRelSrc)[0] + ' import ' + self.moduleName + '\n'
        testFile += '\n'
