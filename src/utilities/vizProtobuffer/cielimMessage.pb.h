...
// repeated double inertialToBodyMrp = 8;
inline int CelestialModel::_internal_inertialtobodymrp_size() const {
  return inertialtobodymrp_.size();
}
inline int CelestialModel::inertialtobodymrp_size() const {
  return _internal_inertialtobodymrp_size();
}
inline void CelestialModel::clear_inertialtobodymrp() {
  inertialtobodymrp_.Clear();
}
inline double CelestialModel::_internal_inertialtobodymrp(int index) const {
  return inertialtobodymrp_.Get(index);
}
inline double CelestialModel::inertialtobodymrp(int index) const {
  // @@protoc_insertion_point(field_get:cielimMessage.CelestialModel.inertialToBodyMrp)
  return _internal_inertialtobodymrp(index);
}
inline void CelestialModel::set_inertialtobodymrp(int index, double value) {
  inertialtobodymrp_.Set(index, value);
  // @@protoc_insertion_point(field_set:cielimMessage.CelestialModel.inertialToBodyMrp)
}
inline void CelestialModel::_internal_add_inertialtobodymrp(double value) {
  inertialtobodymrp_.Add(value);
}
inline void CelestialModel::add_inertialtobodymrp(double value) {
  _internal_add_inertialtobodymrp(value);
  // @@protoc_insertion_point(field_add:cielimMessage.CelestialModel.inertialToBodyMrp)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
CelestialModel::_internal_inertialtobodymrp() const {
  return inertialtobodymrp_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
CelestialModel::inertialtobodymrp() const {
  // @@protoc_insertion_point(field_list:cielimMessage.CelestialModel.inertialToBodyMrp)
  return _internal_inertialtobodymrp();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
CelestialModel::_internal_mutable_inertialtobodymrp() {
  return &inertialtobodymrp_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
CelestialModel::mutable_inertialtobodymrp() {
  // @@protoc_insertion_point(field_mutable_list:cielimMessage.CelestialModel.inertialToBodyMrp)
