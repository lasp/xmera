...
This is a very basic dummy C++ Xmera module that can be used as a template to create other C++ modules.
It mimics the functionality of ``cModuleTemplate``.  See that module for a more complete discussion
