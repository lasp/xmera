...
Note that starting with Xmera 2.0 onwards it is trivial to connect to module messages within
another Xmera process (task group).  There are no additional steps required to establish these connections.
