...
from xmera.simulation import (spacecraft, simpleNav, simpleMassProps, reactionWheelStateEffector,
                                 ...
                                 ReactionWheelPower)
from xmera.utilities import (macros as mc, unitTestSupport as sp, RigidBodyKinematics as rbk,
...
class BSKDynamicModels:
    ...
    def __init__(self, SimBase, dynRate, spacecraftIndex):
        ...
        # Create task
        SimBase.dynProc[spacecraftIndex].addTask(self.taskName, self.processTasksTimeStep)
