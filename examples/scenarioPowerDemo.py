...
:ref:`Folder_power` group of modules, which represent Xmera's low-fidelity power system modeling functionality. Specifically,
...
The simplePower subsystem consists of two kinds of Xmera simModules: :ref:`powerStorageBase` (which is used to represent
