...
def run(show_plots):
    ...
    dynProcess.addTask(measTaskName, simulationTimeStep)
    dynProcess.addTask(fswTaskName, simulationTimeStep)
    ...
    mrpFeedbackControl.setK(7.)
    mrpFeedbackControl.setKi(-1.0)
    mrpFeedbackControl.setP(35.)
