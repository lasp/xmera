...
:ref:`Folder_onboardDataHandling` group of modules, which represent Xmera's low-fidelity data system modeling functionality. Specifically,
...
The :ref:`Folder_onboardDataHandling` subsystem consists of two kinds of Xmera simModules: :ref:`dataStorageUnitBase` (which is used to represent
...
and the rest of Xmera is shown in the figure below.
