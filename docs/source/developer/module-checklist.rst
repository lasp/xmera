...
- Is the module using the ``bskLogging`` Xmera logging function?

Module Documentation
--------------------

Does the module contain a restructured text documentation file ``xxxx.rst``, where ``xxxx`` should be the same name as the module C or C++ file name.  The ``cModuleTemplate`` module contains a sample documentation set for a Xmera module.   The required sections include:
...
As part of the code checkout build and test the associated documentation (see :ref:`create-html-docs`).
