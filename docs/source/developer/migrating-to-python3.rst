...
.. _migrating-to-python3:

Migrating BSK Scripts to Python 3
=================================

With release Xmera v0.8.x onward the software framework now supports using Python 3. The purpose of this document is to illustrate how to
...
depreciated functionality. But, python scripts committed to Xmera
...
Without modification the user will see an error in Python 3 complaining about an unsupported type conversion::
   ...
   File "/Users/hp/Documents/Research/Xmera/dist3/Xmera/simulation/sim_model/sim_model.py", line 4351, in logThisMessage
...
python strings include ``\x`` (raw-latex escape sequences) where x is not a pythonic valid escape character. These warnings did not appear using Python 2, when using strings as input for latex or for other text processing, they should be made a raw string by appending an r::

   r"..."

A sample warning is::

     /Users/hp/Documents/Research/Xmera/src/tests/testScripts/../scenarios/scenarioAttitudeFeedbackRW.py:91: DeprecationWarning: invalid escape sequence \o
