...
Motivation
----------
The nature of a fast evolving software such as Xmera is that systems are consistently improving, many times making
older functionality obsolete.
...
This support page explains the different mechanisms we have available in Xmera to mark code as deprecated.
...
defined in ``Xmera.utilities.deprecated``. This section shows how to deprecate functions, classes, attributes,
and properties.
